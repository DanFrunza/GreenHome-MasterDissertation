"""
Backtesting — LARGE VOLUME regime (>= 1344 training points → Random Forest selected).

Cutoff: 2026-06-18.  Entities have ~1350 hourly training pts (data starts 2026-04-14).
All models use full feature set (11 features: 9 calendar + lag_168h + rolling_7day_mean).
Exact same model code as analytics-service/jobs/prediction.py — no modifications.
...
# ~1350 training pts → Random Forest selected in production
...
OUTPUT_DIR = '/home/dan/Documents/Dizertatie/New/Demo/test/large_volume'
...
if __name__ == '__main__':
    ...
    if all_results:
        plot_combined(all_results, f'{OUTPUT_DIR}/combined_backtest_large.png')
        print("\n── Summary ───────────────────────────────────────")
